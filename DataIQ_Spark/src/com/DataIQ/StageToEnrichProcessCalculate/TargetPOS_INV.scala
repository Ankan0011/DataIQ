...
class TargetPOS_INV extends java.io.Serializable {
  ...
  def IncrementalTarget(Stage_File: String, Enrich_File: String, TargetPOS_Product: String, TargetPOS_Location: String, schemaString: String, Enrich_File_Name: String, UpdatedFiles_Folder_Path: String, FieldName: String, adl_path: String, sqlContext: SQLContext, sc: SparkContext, hadoopConf: Configuration, hdfs: FileSystem, FolderPath_temp: String, ErrorPathRecord: String): Boolean =
    {
      ...
      var sb: StringBuffer = new StringBuffer(CT.CurrentTime() + "  :  Inside method: TargetPOS_INV.IncrementalTarget \n")
      var flag = false
      ...
      try {
        ...
        val Transform_Date_rdd = Stage_File_DF.rdd.map(t => Row(day(t.getString(0), "yyyy-MM-dd"), t.get(1), t.get(2), t.get(3), t.get(4), t.get(5), t.get(6), t.get(7), t.get(8), t.get(9), t.get(10), To_Milli(t.getString(0), "yyyy-MM-dd")))
        ...
        val Temp_Enrich_rdd = Enrich_DF.rdd.map(t => Row(t.get(0), t.get(1), t.get(2), t.get(3), t.get(4), t.get(5), t.get(6), t.get(7), t.get(8), t.get(9), t.get(10), To_Milli(t.getString(0), "MM/dd/yyyy")))
