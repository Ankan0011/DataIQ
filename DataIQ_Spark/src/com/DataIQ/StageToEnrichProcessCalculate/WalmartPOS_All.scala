...
class WalmartPOS_All extends java.io.Serializable {
  ...
  def IncrementWalmart(Stage_File: String, Enrich_File: String, Walmart_Item: String, Walmart_Store: String, schemaString: String, Enrich_File_Name: String, UpdatedFiles_Folder_Path: String, FieldName: String, adl_path: String, sqlContext: SQLContext, sc: SparkContext, hadoopConf: Configuration, hdfs: FileSystem, FolderPath_temp: String, ErrorPathRecord: String): Boolean =
    {
      ...
      try {
        ...
        val Master_walmartITEM_DF = sqlContext.read.format("com.databricks.spark.csv").option("header", "true").option("escape", "\"").option("mode", "permissive").load(Walmart_Item).select("ITEM_KEY").distinct()
        ...
        val Transform_Date_rdd = Stage_File_DF.rdd.map(t => Row(t.get(0), t.get(1), t.get(2), t.get(3), CT.day(t.getString(4), "yyyyMMdd"), t.get(5), t.get(6), t.get(7), t.get(8), t.get(9), t.get(10), t.get(11), t.get(12), t.get(13), t.get(14), t.get(15), t.get(16), t.get(17), t.get(18), t.get(19), t.get(20), t.get(21), t.get(22), t.get(23), t.get(24), t.get(25), t.get(26), t.get(27), t.get(28), To_Milli(t.getString(4), "yyyyMMdd")))
        ...
        val Temp_Enrich_rdd = Enrich_DF.rdd.map(t => Row(t.get(0), t.get(1), t.get(2), t.get(3), t.get(4), t.get(5), t.get(6), t.get(7), t.get(8), t.get(9), t.get(10), t.get(11), t.get(12), t.get(13), t.get(14), t.get(15), t.get(16), t.get(17), t.get(18), t.get(19), t.get(20), t.get(21), t.get(22), t.get(23), t.get(24), t.get(25), t.get(26), t.get(27), t.get(28), To_Milli(t.getString(4), "MM/dd/yyyy")))
