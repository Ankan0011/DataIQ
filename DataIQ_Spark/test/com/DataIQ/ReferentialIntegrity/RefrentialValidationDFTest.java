...
public class RefrentialValidationDFTest extends SharedJavaSparkContext{
	...
	@Test
	public void testCompareDataframe() 
	{
		RefrentialValidationDF rdf = new RefrentialValidationDF();
		...
		Dataset Actual_Result1 = rdf.CompareDataframe(DataFileDF, MasterDF, "ProductNbr", "ProductNbr", sc(), sqlContext);
		Dataset Actual_Result2 = rdf.CompareDataframe(DataFileDF, MasterDF, "ProductNbr", "ProductNbr", sc(), sqlContext);
