...
public class WalmartPOS_USASCCTest extends SharedJavaSparkContext{

	@Test
	public void test() throws Exception {
		WalmartPOS_USASCC wsu = new WalmartPOS_USASCC();
		...
		//flag = wsu.IncrementWalmart(Stage_File, Enrich_File, Walmart_Item, Walmart_Store, Walmart_Schema, "Walmart", Incremental_Folder_Path, Restatement_Folder_Path, "GEO", adl_path, sqlContext, sc(), hadoopConf, hdfs, "", "");
		flag = wsu.IncrementWalmart(Stage_File, Enrich_File, Walmart_Item, Walmart_Store, Walmart_Schema, "Walmart", UpdatedFiles_Folder_Path, "GEO", adl_path, sqlContext, sc(), hadoopConf, hdfs, "", "");
